...
| # | Проблема | Статус |
|---|----------|--------|
| 1 | Устаревший бренд «Гордез» в 160+ местах кода | ✅ Исправлено |
| 2 | Отсутствует hreflang для русскоязычной версии | ✅ Добавлено |
| 3 | Неправильный title карты в футере («Гордез») | ✅ Исправлено |
| 4 | Нет внутренних ссылок с B2B-страниц на /sanpin | ✅ Добавлено |
