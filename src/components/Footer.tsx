  ...
  return (
    <footer className="bg-muted/50 border-t" id="footer">
      <div className="container px-4 py-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href="tel:+73833831223302" className="hover:text-primary transition-colors">
                  +7 (383) 312-23-30
                </a>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t mt-8 pt-8 pb-36 sm:pb-0 text-center text-sm text-muted-foreground">
