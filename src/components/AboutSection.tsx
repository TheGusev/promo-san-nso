        ...
        <AnimatedSection animation="fade-up">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
              <p>
                <strong>ООО «Санитарные Решения»</strong> — это команда сертифицированных специалистов по дезинфекции, дезинсекции и дератизации в Новосибирске и Новосибирской области. С 2020 года мы защищаем дома и бизнес от вредителей, вирусов и бактерий, используя современные технологии и безопасные препараты.
              </p>
            ...
            <p className="text-center text-muted-foreground mt-6 text-sm">
              ИНН: 5410169338 • ОГРН: 1255400030555 • Работаем с 2020 года
            </p>
          </div>
        </AnimatedSection>
      </div>
