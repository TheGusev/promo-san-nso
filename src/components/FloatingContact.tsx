...
export default function FloatingContact() {
  ...
  const handleWhatsApp = () => {
    ...
    window.open(`https://wa.me/${SITE_CONFIG.phoneClean.replace("+", "")}`, "_blank");
    setIsOpen(false);
  };
      ...
      {isOpen && (
        <div className="flex flex-col gap-2 animate-in slide-in-from-bottom-2 fade-in duration-200">
          ...
          <button
            ...
            className="h-12 w-12 rounded-full bg-[#25D366] hover:bg-[#1ebe5b] shadow-lg flex items-center justify-center transition-colors"
            aria-label="WhatsApp"
          >
